...
var createFieldsShp = util.format('ogr2ogr fields.shp %s -t_srs "EPSG:4326" -sql "SELECT FieldID as id, FieldName as name from %s"', filepath, filename);
...
var createCentroidsShp = util.format('ogr2ogr labels.shp %s -t_srs "EPSG:4326" -dialect sqlite -sql "SELECT ST_Centroid(geometry), FieldID as id, FieldName as name from %s"', filepath, filename);
